...
class TypeSpeedGUI:
    ...
    def __init__(self):
        ...
        self.Frequency_list = open("Frequency_list.txt", "r").read().split()

        self.frame = tk.Frame(self.root)

        self.sample_label = tk.Label(self.frame, text=random.sample(self.Frequency_list, 9), font=("Helvetica", 18))
    ...
    def reset(self):
        ...
        self.sample_label.config(text=random.sample(self.Frequency_list, 9))
